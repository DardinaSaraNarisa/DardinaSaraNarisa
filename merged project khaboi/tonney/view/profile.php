...
<head>
 ...
 <?php
    ...
    echo "<p><br></p><p><br></p><h1 align='center'>Profile</h1><table style=\"background-color: lightcyan;\" align='center' border='3px' style='padding: 15px;'><tr><h1  align = \"center\"><td>Profile Name :</td> <td>".$user["Name"]."</h1></td></tr>";
