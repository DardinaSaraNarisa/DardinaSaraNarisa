...
<body>
    ...
    <fieldset align="center">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <h2 class="error" align = "center">Profile Name : <input type='text' name='name' value="<?php echo $user["Name"] ?>"></h2>
            <span class="error2">* <?php echo $nameErr;?></span>
            <h2 class="error" align = "center">Email Address :<input type='text' name='email'value="<?php echo $user["Email"] ?>" ></h2>
